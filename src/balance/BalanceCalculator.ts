...
export function defaultBalanceConfig(): BalanceConfig {
  return {
    ...
    laserRangePerLevel: CONFIG.TOWER_RANGE_BONUS_PER_LEVEL,
    laserUpgradeCost: CONFIG.TOWER_LASER_UPGRADE_COST,
    slowBaseFactor: CONFIG.TOWER_WEAKNESS_BASE_ATTACK_REDUCTION,
    slowBaseRange: CONFIG.TOWER_WEAKNESS_BASE_RANGE,
    slowFactorPerLevel: CONFIG.TOWER_WEAKNESS_FACTOR_PER_LEVEL,
    slowRangePerLevel: CONFIG.TOWER_RANGE_BONUS_PER_LEVEL,
    slowUpgradeCost: CONFIG.TOWER_WEAKNESS_UPGRADE_COST,
