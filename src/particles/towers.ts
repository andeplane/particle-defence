...
export function getLaserStats(level: number): { damage: number; range: number; attackSpeed: number } {
  return {
...
export function getSlowStats(level: number): { slowFactor: number; range: number } {
  return {
